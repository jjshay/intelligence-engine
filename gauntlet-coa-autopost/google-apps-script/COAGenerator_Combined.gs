...
const CONFIG = {
  ...
  // Column mapping (0-indexed) - matches COA2 sheet (21 columns, A-U)
  COLUMNS: {
    ...
    DATE: 4,                        // E: Date
    SIZE: 5,                        // F: Size
    CONDITION: 6,                   // G: Condition
    DESCRIPTION: 7,                 // H: Description
    PROVENANCE: 8,                  // I: Provenance (header says "Provience" - misspelled)
    EDITION: 9,                     // J: Edition
    MEDIUM: 10,                     // K: Medium
    ASSIGNEE: 11,                   // L: Assignee
    THIRD_PARTY_AUTH_NOTES: 12,     // M: Third Party Auth Notes
    IMAGE_URL: 13,                  // N: Image_URL
    NFT_TOKEN_ID: 14,               // O: NFT_TokenID
    SHORT_URL: 15,                  // P: Short_URL (output - Bit.ly link)
    BLOCKCHAIN_URL: 16,             // Q: Blockchain_URL
    NFT_URL: 17,                    // R: NFT_URL
    CERT_URL: 18,                   // S: Cert_URL (output - Google Drive link)
    STATUS: 19,                     // T: Status / Done
    COMPLETION_DATE: 20             // U: Completion Date (output - timestamp)
  },
...
function generateAllCertificates() {
  ...
  for (let i = 1; i < data.length; i++) {
    ...
    const alreadyGenerated = row[CONFIG.COLUMNS.STATUS] || row[CONFIG.COLUMNS.COMPLETION_DATE];
...
function processRow(sheet, rowNum, row, folder) {
  ...
  sheet.getRange(rowNum, COL.STATUS + 1).setValue(new Date().toISOString());
  sheet.getRange(rowNum, COL.COMPLETION_DATE + 1).setValue(new Date().toISOString());
